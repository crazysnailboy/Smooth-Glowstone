...
public class ModBlockColorVariantBase extends Block {

	
	public static final PropertyEnum PROPERTYCOLOUR = PropertyEnum.create("colour", EnumColour.class);

	
	public ModBlockColorVariantBase(Material materialIn) 
	{
		super(materialIn);
	...
	{
        return ((ModBlockColorVariantBase.EnumColour)state.getValue(PROPERTYCOLOUR)).getMetadata();
	}
	...
	{
        return this.getDefaultState().withProperty(PROPERTYCOLOUR, ModBlockColorVariantBase.EnumColour.byMetadata(meta));
	}
